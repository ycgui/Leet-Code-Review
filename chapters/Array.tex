...
\section{Two Sum (Amazon 10.04.2016)}
...
\section{Rotate Image (M) (Amazon 09.16.2016)}
...
public:
    void rotate(vector<vector<int> > &matrix) {
        int n = matrix.size();
        // iterate from the outside layer to the inside layer
        for (int i = 0; i < n / 2; ++i) { 
